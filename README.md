...
![Flutter Doctor](capturas/flutter_doctor.png)

### 2. Proyecto en Visual Studio Code
![VS Code](capturas/vscode_project.png)

### 3. Emulador Android funcionando
![Emulador](capturas/emulador.png)

### 4. Aplicación ejecutándose
![App Ejecutándose](capturas/app_ejecutandose.png)

### 5. Instalación del paquete (pub get)
![Pub Get](capturas/pub_get.png)

### 6. Pubspec.yaml con el paquete agregado
![Pubspec](capturas/pubspec_yaml.png)

### 7. Repositorio en GitHub
![GitHub](capturas/repositorio_github.png)
